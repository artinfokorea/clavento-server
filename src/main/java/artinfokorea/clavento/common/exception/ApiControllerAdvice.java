...
class ApiControllerAdvice {
	...
	public ResponseEntity<Object> invalidRequestHandler(MethodArgumentNotValidException e) {
		ExceptionMessage exceptionMessage = new ExceptionMessage(ErrorType.BAD_REQUEST);
		ApiResponse<Object> response = new ApiResponse<>(ResultType.FAIL, exceptionMessage, null);
	...
	public ResponseEntity<Object> handleException(Exception e) {
		...
		ExceptionMessage exceptionMessage = new ExceptionMessage(ErrorType.INTERNAL_SERVER_ERROR);
		ApiResponse<Object> response = new ApiResponse<>(ResultType.FAIL, exceptionMessage, null);
